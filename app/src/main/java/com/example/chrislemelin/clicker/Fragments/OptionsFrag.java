 ...
 * {@link OptionsFrag.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link OptionsFrag#newInstance} factory method to
...
public class OptionsFrag extends Fragment {
     ...
     * @return A new instance of fragment OptionsFrag.
     */
    ...
    public void onButtonPressed(String uri) {
        if (mListener != null) {
            mListener.onOptionInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onOptionInteraction(String s);
    }
}
